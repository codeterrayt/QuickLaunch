...
const app = express();
const { createAndStartContainer, startContainer,pauseContainer, stopContainer, CONSTANTS } = require("./docker");
...
app.all("/spawn/container", async (req, res) => {
    ...
    try {
        ...
        return res.status(500).send({"message":"Failed to start container, Image Not Found"});
    }
});
